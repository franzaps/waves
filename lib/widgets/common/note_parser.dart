...
class NoteParser {
  /// Default hashtag navigation callback - navigates to hashtag screen
  static VoidCallback? defaultHashtagTap(BuildContext context, String hashtag) {
    return () => context.push('/hashtag/$hashtag');
  }
          ...
          replacement =
              ...
              HashtagWidget(
                ...
                onTap: onHashtagTap != null
                    ...
                    : defaultHashtagTap(context, match.cleanEntity),
              );
          break;
      }
